...
#define STRING_CONFIG_H_AUTHOR "z-unlimited DEV" // Who made the changes.
#endif
...
#ifdef UM2PLUS
#define DEFAULT_AXIS_DIR 0x3F
#else
#define DEFAULT_AXIS_DIR 0x17
#endif
...
// Travel limits after homing
  ...
  #else
    #define Z_MAX_POS 3600  // joris zunlimited
  #endif // UM2GO
#endif // Z_MAX_POS
...
// default settings
#ifdef UM2PLUS
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.0,80.0,1333.3333,369}  // default steps per unit for ultimaker2.1 JarJar with joris zunlimited
#else
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.0,80.0,1333.3333,282}  // default steps per unit for ultimaker2 with joris zunlimited
#endif
#define DEFAULT_MAX_FEEDRATE          {200, 200, 10, 45}    // (mm/sec) joris zunlimited
#define DEFAULT_MAX_ACCELERATION      {3000,3000,100,10000}    // X, Y, Z, E maximum start speed for accelerated moves. joris zunlimited

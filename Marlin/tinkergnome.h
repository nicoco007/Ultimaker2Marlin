...
FORCE_INLINE void lcd_print_tune_standby0_diff() { lcd_tune_value(standby_temperature_diff[0], max(-MAX_STANDBY_DIFF, -target_temperature[0]), min(MAX_STANDBY_DIFF, get_maxtemp(0) - target_temperature[0] - 15)); }
FORCE_INLINE void lcd_print_tune_standby1_diff() { lcd_tune_value(standby_temperature_diff[1], max(-MAX_STANDBY_DIFF, -target_temperature[1]), min(MAX_STANDBY_DIFF, get_maxtemp(1) - target_temperature[1] - 15)); }
#endif
